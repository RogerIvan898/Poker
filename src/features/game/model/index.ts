...
const initialState: GameState = {
  tableId: null,
  players: [
    { id: '787', name: 'You', chips: 1250, status: 'ACTIVE', hand: [{rank: 'A', suit: 'hearts'}, {rank: 'A', suit: 'hearts'}]},
    { id: '2', name: 'Anna', chips: 2400, status: 'ACTIVE', hand:[null, null]},
    { id: '3', name: 'Mark', chips: 3200, status: 'SEATED', isDealer: false, hand:[null, null] },
    { id: '4', name: 'Luca', chips: 680, status: 'SEATED', isDealer: false, hand:[null, null] },
    { id: '100', name: 'Serg', chips: 4100, status: 'SEATED', isDealer: true, hand:[null, null] },
    { id: '6', name: 'Priya', chips: 1750, status: 'SEATED', isDealer: false, hand:[null, null] },
    { id: '90', name: 'Lucaй', chips: 680, status: 'SIT_OUT', isDealer: false, hand:[null, null] },
    { id: '89', name: 'Sergй', chips: 4100, status: 'SEATED', isDealer: true, hand:[null, null] },
    { id: '09', name: 'Priyaq', chips: 1750, status: 'FOLDED', isDealer: false, hand:[null, null] },
  ],
  dealerId: null,
  currentTurnId: null,
  round: "IDLE",
