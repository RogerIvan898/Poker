...
const initialState: GameState = {
  tableId: null,
  players: [
    { id: '787', name: 'You', stack: 12.5, status: 'ACTIVE', hand: [{rank: 'A', suit: 'hearts'}, {rank: 'A', suit: 'hearts'}], seat: 6},
    { id: '2', name: 'Anna', stack: 2.4, status: 'SEATED', hand:[null, null], seat: 7},
    { id: '3', name: 'Mark', stack: 32, status: 'SEATED', hand:[null, null], seat: 8 },
    { id: '4', name: 'Luca', stack: 98, status: 'SIT_OUT', hand:[null, null], seat: 5},
    { id: '100', name: 'Serg', stack: 4.1, status: 'SEATED', hand:[null, null], seat: 4 },
    { id: '6', name: 'Priya', stack: 17, status: 'SEATED', hand:[null, null], seat: 3 },
    { id: '90', name: 'Lucaй', stack: 6.8, status: 'SEATED', hand:[null, null], seat: 2 },
    { id: '89', name: 'Sergй', stack: 41, status: 'SEATED', hand:[null, null], seat: 1 },
    { id: '09', name: 'Priyaq', stack: 17, status: 'FOLDED', hand:[null, null], seat: 0 },
  ],
  dealerId: '100',
  currentTurnId: '787',
  round: "IDLE",
